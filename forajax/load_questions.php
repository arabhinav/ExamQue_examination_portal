            ...
            <td style="padding-left: 10px;">
                    <?php
                        if (strpos($opt1,'images/')!=false) {
                            ?>
                            <img src="admin/<?php echo $opt1; ?>" alt="option-img" height="40" width="40">
                            <?php
                        }
                        else
                        {
            ...
            <td style="padding-left: 10px;">
                    <?php
                        if (strpos($opt3,'images/')!=false) {
                            ?>
                            <img src="admin/<?php echo $opt3; ?>" alt="option-img" height="40" width="40">
                            <?php
                        }
                        else
                        {
            ...
            <td style="padding-left: 10px;">
                    <?php
                        if (strpos($opt4,'images/')!=false) {
                            ?>
                            <img src="admin/<?php echo $opt4; ?>" alt="option-img" height="40" width="40">
                            <?php
                        }
                        else
                        {
